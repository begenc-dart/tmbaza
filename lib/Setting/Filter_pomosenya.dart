...
class Filter_Pomosenya extends StatefulWidget {
  const Filter_Pomosenya({Key? key}) : super(key: key);

  @override
  _Filter_PomosenyaState createState() => _Filter_PomosenyaState();
}

class _Filter_PomosenyaState extends State<Filter_Pomosenya> {
  String? _chosenValue;
  String? _zaloge;
  String? _text;
