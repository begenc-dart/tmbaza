...
class Filter_ucastok extends StatefulWidget {
  const Filter_ucastok({Key? key}) : super(key: key);

  @override
  _Filter_ucastokState createState() => _Filter_ucastokState();
}

class _Filter_ucastokState extends State<Filter_ucastok> {
  String? _chosenValue;
  String? _nazwan;
  String? _delimost;
  String? _zaloge;
