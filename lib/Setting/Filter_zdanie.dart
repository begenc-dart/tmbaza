...
class Filter_Zdanya extends StatefulWidget {
  const Filter_Zdanya({Key? key}) : super(key: key);

  @override
  _Filter_ZdanyaState createState() => _Filter_ZdanyaState();
}

class _Filter_ZdanyaState extends State<Filter_Zdanya> {
  String? _chosenValue;
