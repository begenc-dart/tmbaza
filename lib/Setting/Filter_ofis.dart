...
class Filter_ofis extends StatefulWidget {
  const Filter_ofis({Key? key}) : super(key: key);

  @override
  _Filter_ofisState createState() => _Filter_ofisState();
}

class _Filter_ofisState extends State<Filter_ofis> {
  String? _chosenValue;
  String? _chosenTip;
  String? _grupa;
