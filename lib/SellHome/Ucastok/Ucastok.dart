...
class Ucastok extends StatefulWidget {
  const Ucastok({Key? key}) : super(key: key);

  @override
  _UcastokState createState() => _UcastokState();
}

class _UcastokState extends State<Ucastok> {
  bool obmen = false;
  bool kopiya = false;
