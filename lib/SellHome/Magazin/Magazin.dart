...
class _MagazinState extends State<Magazin> {
  ...
  final TextEditingController _rynki = TextEditingController();
  final TextEditingController _sena = TextEditingController();
  final TextEditingController _plos = TextEditingController();
  final TextEditingController _textOb = TextEditingController();
  bool obmen = false;
  bool kopiya = false;
  String? imeno;
  String? mes;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            "Название торгового центра, рынка",
                            style: TextStyle(
                                fontWeight: FontWeight.w400,
                                fontSize: 14,
                                color: Color.fromRGBO(163, 171, 179, 1)),
