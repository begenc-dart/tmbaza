...
class Zadaniya extends StatefulWidget {
  const Zadaniya({Key? key}) : super(key: key);

  @override
  _ZadaniyaState createState() => _ZadaniyaState();
}

class _ZadaniyaState extends State<Zadaniya> {
  bool obmen = false;
  bool kopiya = false;
  ...
  final TextEditingController _kolowin = TextEditingController();
  final TextEditingController _pla = TextEditingController();
  final TextEditingController _sotok = TextEditingController();
  final TextEditingController _etaz = TextEditingController();
  final TextEditingController _kry = TextEditingController();
  final TextEditingController _poto = TextEditingController();
  final TextEditingController _par = TextEditingController();
